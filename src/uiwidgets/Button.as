...
public class Button extends Sprite {
	...
	public function addContextMenu(label:String, action:Function = null):void {
		//addEventListener(MouseEvent.CONTEXT_MENU, action);
		//var cm:ContextMenuClipboardItemsExample = new ContextMenuClipboardItemsExample();
		//addChild(cm);
	}
